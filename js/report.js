  ...
  el.innerHTML =
    ...
    '<div class="roadmap-month">' +
      ...
      '<div class="roadmap-week"><h4>Неделя 3–4: Первое внедрение автоматизации</h4>' +
        '<p>Первое внедрение Финтабло — совместно с отделом заботы. Сейчас вы тратите ~' + m.routineHours + ' ч/мес на рутину. Автоматизируете один процесс у 2 клиентов. <strong>Результат:</strong> минус ' + Math.min(m.routineHours, Math.round(m.clients * 2.5)) + ' ч/мес рутины.</p></div>' +
    '</div>' +
